            ...
            <div class="col-lg-4">
                <div class="contact-info-content mb-30 rmb-55" data-aos="fade-up" data-aos-duration="1500"
                    ...
                    <div class="section-title mb-30">
                        <h2 class="benefit-title text-black">Hãy nói chuyện với các hướng dẫn viên du lịch chuyên nghiệp của chúng tôi</h2>
                    </div>
                        ...
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="far fa-envelope"></i> <a
                                        href="mailto:anhthuduongbinhmy.dev@gmail.com">anhthuduongbinhmy.dev@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="fal fa-map-marker-alt"></i> Văn phòng toà A6-103</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="fal fa-map-marker-alt"></i> P. Nguyễn Trác, Yên Nghĩa</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="comment-form bgc-lighter z-1 rel mb-30 rmb-55">
                    <form id="contactForm" class="contactForm" name="contactForm" action="{{ route('create-contact') }}"
                        ...
                        <div class="section-title">
                            <h2 class="benefit-title text-black">Liên hệ</h2>
                        </div>
